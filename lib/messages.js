...
function defineCore () {
  ...
  function encodingLength (obj) {
    ...
    var len = enc[0].encodingLength(obj.seed)
    length += 1 + len
    if (!defined(obj.writable)) throw new Error("writable is required")
    var len = enc[0].encodingLength(obj.writable)
    length += 1 + len
    ...
    if (defined(obj.valueEncoding)) {
      var len = enc[1].encodingLength(obj.valueEncoding)
      length += 1 + len
    }
    if (defined(obj.name)) {
    ...
    if (defined(obj.description)) {
      var len = enc[1].encodingLength(obj.description)
      length += 1 + len
    }
  ...
  function encode (obj, buf, offset) {
    ...
    if (!defined(obj.seed)) throw new Error("seed is required")
    buf[offset++] = 8
    enc[0].encode(obj.seed, buf, offset)
    offset += enc[0].encode.bytes
    if (!defined(obj.writable)) throw new Error("writable is required")
    buf[offset++] = 16
    enc[0].encode(obj.writable, buf, offset)
    offset += enc[0].encode.bytes
    if (!defined(obj.sparse)) throw new Error("sparse is required")
    buf[offset++] = 24
    ...
    if (defined(obj.valueEncoding)) {
      buf[offset++] = 34
      enc[1].encode(obj.valueEncoding, buf, offset)
    ...
    if (defined(obj.description)) {
      buf[offset++] = 50
      enc[1].encode(obj.description, buf, offset)
      offset += enc[1].encode.bytes
    }
    if (defined(obj.prefetch)) {
      buf[offset++] = 58
  ...
  function decode (buf, offset, end) {
    ...
    while (true) {
      ...
      switch (tag) {
        case 1:
        obj.seed = enc[0].decode(buf, offset)
        offset += enc[0].decode.bytes
        found0 = true
        break
        case 2:
        obj.writable = enc[0].decode(buf, offset)
        offset += enc[0].decode.bytes
        found1 = true
        break
        case 3:
        ...
        break
        case 4:
        obj.valueEncoding = enc[1].decode(buf, offset)
        ...
        break
        case 6:
        obj.description = enc[1].decode(buf, offset)
        offset += enc[1].decode.bytes
        break
        case 7:
